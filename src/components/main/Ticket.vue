<template>
    <div>
                ...
                <v-card flat :elevation="hover ? 2 : 0" class="ticket recommended">
                    <v-row>
                        <v-col cols="12" md="4" class="py-0">
                            ...
                            <v-menu open-on-hover top offset-y attach="menuRecommended">
                                <template v-slot:activator="{ on }">
                                    <v-row class="px-3" id="menuRecommended">
                                        <v-col
        ...
        <v-hover v-slot:default="{ hover }">
            <v-card flat :elevation="hover ? 2 : 0" class=" ticket header_the_best">
                ...
                <v-row>
                    <v-col cols="12" md="4" class="py-0">
                        ...
                        <v-menu open-on-hover top offset-y attach="menuTheBest">
                            <template v-slot:activator="{ on }">
                                <v-row class="px-3" id="menuTheBest">
                                    <v-col
                                            v-for="(item,i) in $store.state.images[0]"
                                            v-if="i <= 10"
                                            :key="i"
        ...
        <v-hover v-slot:default="{ hover }">
            <v-card flat :elevation="hover ? 2 : 0" class=" ticket header_alarm">
                ...
                <v-row>
                    <v-col cols="12" md="4" class="py-0">
                        ...
                        <v-menu open-on-hover top offset-y attach="menuAlarm">
                            <template v-slot:activator="{ on }">
                                <v-row class="px-3" id="menuAlarm">
                                    <v-col
                                            v-for="(item,i) in $store.state.images[0]"
                                            v-if="i <= 10"
                                            :key="i"
