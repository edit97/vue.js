                        ...
                        <v-list-item-group
                            ...
                            >
                                <v-list-item dense color="#5392f9">
                                    ...
                                    <div >
                                        <span :class="(check_room === 0) ? 'white--text' : 'blue_text'">Barcelona</span>,
                                ...
                                <v-list-item color="#5392f9">
                                    ...
                                    <div>
                                    <span class="font-weight-bold"><span :class="(check_room === 1) ? 'white--text' : 'blue_text'">Barcelona</span>
                                ...
                                <v-list-item color="#5392f9">
                                    ...
                                    <div>
                                        <span class="font-weight-bold">Stay in the heart of <span :class="(check_room === 2) ? 'white--text' : 'blue_text'">Barcelona</span></span><br>
                                        <span>Spain</span>
                                    </div>
                                    <v-spacer></v-spacer>
                        ...
                        <v-layout>
                            <v-flex class="search_menu">
                                ...
                                >
                                    ...
                                    <v-list-item @click="traveler_business()">
                                        Business travelers
                                    </v-list-item>
                                </v-list-item-group>
                            </v-flex>
                            <v-flex sm6 class="search_menu" v-if="menu_family === true">
                            ...
                            <v-flex sm6 class="search_menu" v-if="menu_business === true">
                                <v-content class="pa-3">
                                    <v-layout class="menu_counter">
                                        <el-input-number
